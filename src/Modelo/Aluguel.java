...
public class Aluguel {
    ...
    public int getCod_dvd() { return cod_dvd; }
    public void setCod_dvd(int cod_dvd) { this.cod_dvd = cod_dvd; }
    ...
    public String getData_aluguel() { return data_aluguel; }
    public void setData_aluguel(String data_aluguel) { this.data_aluguel = data_aluguel; }
