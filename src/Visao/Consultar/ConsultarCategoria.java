     ...
     String codigo = jTF_Codigo.getText();
        ...
        try {
            if (!codigo.equals("")) {
                 ...
                 lista = sql.Pesquisar_Cod_Categoria(cod);
            }
        } catch (NumberFormatException e) {
            // Se digitar letra no lugar de número, não faz nada ou limpa a lista
        }
...
Connection con = Conexao.AbrirConexao();
        ...
        List<Categoria> lista = sql.Listar_Categoria();
...
private void AtualizarTabela(List<Categoria> lista) {
        ...
        // 2. Limpa as linhas antigas
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
        
        // 3. Adiciona as novas linhas
