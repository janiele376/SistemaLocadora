...
public class ConsultarFilme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TABELA2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Titulo", "Ano", "Categoria", "Classificação", "Capa"
            }
        ) {
...
String titulo = jTF_Nome.getText(); // Verifique se o nome da variável é jTF_Titulo
        
        Connection con = Conexao.AbrirConexao();
        FilmeDAO sql = new FilmeDAO(con);
        
        // Busca a lista pelo título
...
String codigo = jTF_Codigo.getText();
        ...
        try {
            if (!codigo.equals("")) {
                 ...
                 lista = sql.Pesquisar_Cod_Filme(cod);
            }
...
Connection con = Conexao.AbrirConexao();
        ...
        List<Filme> lista = sql.Listar_Filme();
        
        AtualizarTabela(lista);
        
        Conexao.FecharConexao(con);     // TODO add your handling code here:
    }//GEN-LAST:event_bt_todosActionPerformed
private void AtualizarTabela(List<Filme> lista) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            tbm.addRow(new Object[] {
                lista.get(i).getCodigo(),        // Coluna 0
                lista.get(i).getTitulo(),        // Coluna 1
                lista.get(i).getAno(),           // Coluna 2
                lista.get(i).getDuracao(),       // Coluna 3
                lista.get(i).getCod_categoria(),   // Coluna 4 (Mostra o ID da Categoria)
                lista.get(i).getCod_classificacao()// Coluna 5 (Mostra o ID da Classificação)
            });
        }
    }
    /**
