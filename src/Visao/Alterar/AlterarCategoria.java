...
public class AlterarCategoria extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AlterarClassificação
     */
...
String codigo = jTF_CodigoPesquisa.getText();
        ...
        if (codigo.equals("")) {
            JOptionPane.showMessageDialog(null, "Digite o código da Categoria para pesquisar!");
        } else {
            ...
            // O seu DAO retorna uma Lista, então pegamos o primeiro item
            List<Categoria> lista = sql.Pesquisar_Cod_Categoria(cod);
            ...
            if (lista.isEmpty()) {
                ...
                // Preenche o campo Nome com o que veio do banco
...
String codigo = jTF_Codigo.getText();
        ...
        if (codigo.equals("") || nome.equals("")) {
            JOptionPane.showMessageDialog(null, "Pesquise uma categoria e digite o novo nome!", 
            ...
            // Define o ID (quem será alterado) e o Nome (o novo valor)
            a.setCodigo(Integer.parseInt(codigo));
            a.setNome(nome);
            
            String resultado = sql.Alterar_Categoria(a);
