...
String nome = jTF_Nome.getText();
        ...
        if (nome.equals("")) {
            JOptionPane.showMessageDialog(null, "Digite o Nome da Classificação para excluir!", 
                    "Vídeo Locadora", JOptionPane.WARNING_MESSAGE);
        } else {
            Connection con = Conexao.AbrirConexao();
            ClassificacaoDAO sql = new ClassificacaoDAO(con);
            
            // 2. Busca a classificação pelo NOME para descobrir o ID
            List<Classificacao> lista = sql.Pesquisar_Nome_Classificacao(nome);
            
            if (lista.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Nenhuma classificação encontrada com esse nome!", 
                        "Erro", JOptionPane.ERROR_MESSAGE);
            } else {
                // 3. Pega o primeiro item encontrado
                Classificacao a = lista.get(0);
                
                // 4. Pergunta de segurança
                // Mostramos o nome e o preço para ter certeza
                int opcao = JOptionPane.showConfirmDialog(null, 
                        "Encontramos a classificação: " + a.getNome() + "\n" +
                        "Preço: R$ " + a.getPreco() + "\n\n" +
                        "Tem certeza que deseja excluir?", 
                        "Confirmação", JOptionPane.YES_NO_OPTION);
                
                // 5. Se confirmar, exclui
                if (opcao == JOptionPane.YES_OPTION) {
                    String resultado = sql.Excluir_Classificacao(a);
